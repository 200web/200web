...
import { SECTION_PATH, ADMIN_PATH, BUY_NOW_URL, DOCS_URL, FREEBIES_URL, CONTACT_PATH } from '@/path';
...
export const navbar = {
  ...
  navItems: [
    ...
    // landingMegamenu,
    { id: 'components', title: 'Services', link: SECTION_PATH },
    { id: 'cases', title: 'Cases', link: SECTION_PATH },
    { id: 'dashboard', title: 'Dashboard', link: ADMIN_PATH, ...linkProps },
    { id: 'blog', title: 'Blog', link: SECTION_PATH },
    // pagesMegamenu,
